...
JNIEXPORT jlong JNICALL IMAGE_FUNC(hist_mnmx)(JNIEnv *env, jclass clazz, jlong a,
                                              jint nbins, jfloat min, jfloat max)
{
    af_array ret = 0;
...
JNIEXPORT jlong JNICALL IMAGE_FUNC(rotate)(JNIEnv *env, jclass clazz, jlong a,
                                           jfloat theta, jboolean crop, jint method)
{
    af_array ret = 0;
...
JNIEXPORT jlong JNICALL IMAGE_FUNC(resize2)(JNIEnv *env, jclass clazz, jlong a,
                                            jfloat scalex, jfloat scaley, jint method)
{
    af_array ret = 0;
    dim_t dims[4];
    AF_TO_JAVA(af_get_dims(dims + 0,
...
JNIEXPORT jlong JNICALL IMAGE_FUNC(resize3)(JNIEnv *env, jclass clazz, jlong a,
                                            jint height, jint width, jint method)
{
    af_array ret = 0;
